    ...
    <div class='py-2'>
        <div class='max-w-7xl mx-auto sm:px-6 lg:px-8'>
            <div class='bg-red-500 overflow-hidden shadow-sm sm:rounded-lg'>
                <h1 class='p-5 font-blod text-white'>Create Post</h1>
                ...
                <div class="p-6 bg-gray-700">
                    <form  class="w-full max-w-sm" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="md:flex md:items-center mb-6">
                            ...
                            <div class="md:w-2/3">
                                <textarea class="resize border rounded-md" name="body" style="width:250px;"></textarea>
                            </div>
                        </div>
                        ...
                        <div class="md:flex md:items-center mb-6">
                            ...
                            <div class="md:w-2/3">
                                <input class="border-2 border-gray-200 rounded w-full py-2 px-4" id="photo" type="file" name="photo">
                            </div>
                        </div>
